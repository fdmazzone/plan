...
\item Mayor flexibilidad del ciclo de especialización.  En relación a las  materias optativas no se especifican ni sus nombres ni sus  contenidos. La existencia de diversas materias optativas con diferentes denominaciones causa problemas en la ejecución del plan a nivel administrativo.  
\end{enumerate}
...
\multicolumn{4}{|l|}{\textbf{Total de Horas del Plan de estudios}}                               &\textbf{3108}         \\ \hline
\end{tabularx}
\end{center}
\normalsize
...
El estudiante debe acreditar 60hs \textcolor{green}{ANALIZAR CANTIDAD} en cursos y seminarios extracurriculares y otras actividades. Pudiendo acreditar
\begin{itemize}
