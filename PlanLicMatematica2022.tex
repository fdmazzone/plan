...
administrativo suficiente para desarrollar esta carrera. Para la ejecución de la carrera   se requerirá la participación del área de registro de alumnos de la FCEFQyN, del Departamento de Coordinación de Aulas y Horarios (DCAyH), del área de Salud, Departamento de Becas, Biblioteca, Diplomas y del personal administrativo afectado al DM.  
